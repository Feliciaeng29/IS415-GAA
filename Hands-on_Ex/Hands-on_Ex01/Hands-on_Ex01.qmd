...
categories: ["Hands-on Exercise", "tidyverse", "sf", "ggplot2", "dplyr", "data wrangling"]
execute: 
  warning: false
date: "`r Sys.Date()`"
---
...
>
> -   `nQuadSegs` is an argument to specify the number of segment to be used to create a buffer.  When the number increases, for example from 1 to 2 and 2 to 5 , the buffer will be more rounded especially at the edge of the buffer
