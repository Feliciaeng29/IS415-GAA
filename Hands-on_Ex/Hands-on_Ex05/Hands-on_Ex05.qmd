...
categories: ["Hands-on Exercise", "sf", "spdep", "tmap", "tidyverse", "Global Measures of Spatial Autocorrelation"]
date: 02-04-2024
output:
    toc: true
    toc_depth: 4
...
To change the fig width and height to ensure the legend does not overlap with the map! 
...
**Challenge:** 
Instead of using Base Graph to plot the values, plot the values by using ggplot2 package.
