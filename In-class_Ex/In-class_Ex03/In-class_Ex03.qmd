...
In this section ***sf*** package will be used to import these 3 geosptial data sets into R.
...
environment:
st_combine: mini points
st_union: all will be combine into one point
...
chilcare_ppp is a list:
Have window and the information in the data.
...
We can check the duplication in ppp objects by using the code chunk
(Remember: Always remember to check for duplicates in data)
