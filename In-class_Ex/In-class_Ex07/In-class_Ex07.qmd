...
description: |
  Geographical segmentation by using appropriate R packages. I will also use approriate R packages for performing cluster analysis and visualising clustering results.
author:
  - name:Felicia Eng
output:
...
Exlcuse rgdal but include sp. Remove rgdal as it is already retired.
...
So you know what is the object class
...
Using the scaling method to derive ownership.
...
The gap analysis here will be able to see the statistics
...
If i change it to 9 it is only going to change in terms of the aggregation. They are not going to change their position.
